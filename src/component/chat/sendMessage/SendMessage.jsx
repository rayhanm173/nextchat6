      ...
      <form onSubmit={(e) => handleSend(e)}>
        <div className="sendmsgwrapper">
          <div className="icons">
            ...
            >
              {(mediaRecorder.current && mediaRecorder.current.state === "recording")?stopsvg:noMic?nomicsvg:micsvg}{" "}
            </div>
          </div>
